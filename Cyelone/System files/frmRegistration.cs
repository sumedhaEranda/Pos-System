    ...
    public partial class frmRegistration : Form
    {
        ...
        private void Register_Click(object sender, EventArgs e)
        {
           ...
           /* if (txtEmail_Address.Text == "")
            ...
            try
            {
                ...
                con.Open();
                string ct = "select username from User_info where username=@find";
                ...
                con = new SqlConnection(cs.DBConn);
                con.Open();
                string ct1 = "select Email from User_info where Email='" + txtEmail_Address.Text + "'";
                ...
                string cb = "insert into User_info(Username,UsertYpe,Password,ContactNo,Email,Name,JoiningDate) VALUES ('" + txtUsername.Text + "','" + cmbUserType.Text + "','" + txtPassword.Text + "','" + txtContact_no.Text + "','" + txtEmail_Address.Text + "','" + txtName.Text + "','" + System.DateTime.Now + "')";
        ...
        private void CheckAvailability_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                con = new SqlConnection(cs.DBConn);
                con.Open();
                string ct = "select username from User_info where username='" + txtUsername.Text + "'";
        ...
        private void Username_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "SELECT Usertype,password,name,contactno,email FROM User_info WHERE username = '" + txtUsername.Text.Trim() + "'";
                rdr = cmd.ExecuteReader();
        ...
        private void Autocomplete()
        {
            ...
            con = new SqlConnection(cs.DBConn);
            con.Open();
            SqlCommand cmd = new SqlCommand("SELECT username FROM User_info", con);
        ...
        private void Update_record_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string cb = "update User_info set usertype='" + cmbUserType.Text + "', password='" + txtPassword.Text + "',contactno='" + txtContact_no.Text + "',email='" + txtEmail_Address.Text + "',name='" + txtName.Text + "' where username='" + txtUsername.Text + "'";
                cmd = new SqlCommand(cb);
                cmd.Connection = con;
                cmd.ExecuteReader();
                con.Close();
        ...
        private void delete_records()
        {
            ...
            try
            {
                ...
                con = new SqlConnection(cs.DBConn);
                con.Open();
                string ct = "delete from User_info where Username='" + txtUsername.Text + "'";
                cmd = new SqlCommand(ct);
                cmd.Connection = con;
