       ...
       SqlCommand cmd = null;
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                con.Open();
                string co = "Update User_info set Password = '" + txtNewPassword.Text + "'where UserName='" + txtUserName.Text + "' and Password = '" + txtOldPassword.Text + "'";
        ...
        private void frmChangePassword_Load(object sender, EventArgs e)
        {
            ...
            this.label5.ForeColor = Properties.Settings.Default.FontHeaderColor;
        }
